...
//     let source = the.editor ? the.editor.getValue() : $('#source').val(),
//         output,
//         opts = {};
...
//     let selectedOptions = JSON.stringify(opts, null, 2);
...
//     let encoded = encodeURIComponent(getSubmitIssueBody()).replace(/%20/g, "+");
...
//     let input = the.lastInput;
//     let output = the.lastOutput;
...
//     let tf = JSON.parse(sessionStorage.getItem("LanguageForFileExtension"));

//     let filteredRows = JSON.parse(tf).filter(function (entry) {
//         let evalStr = entry.fileextension;
...
//         let newLanguage = getLanguageForFileExtension(fileExtension);
...
//                 let gf = JSON.parse(sessionStorage.getItem("SpecialFiles"));

//                 let filteredRows = JSON.parse(gf).filter(function (entry) {
//                     let evalStr = entry.filename;
...
//     let tf = JSON.parse(sessionStorage.getItem("CodeCommentsConditions"));
...
//     let tf = JSON.parse(sessionStorage.getItem("CommentsCombination"));
//     let rows = JSON.parse(tf);

//     let arr = [];

//     for (let i = 0; i < rows.length; i++) {
//         let r_comment_start = rows[i].comment_start;
//         let r_comment_end = rows[i].comment_end;
...
//             let commentStart = codetext.indexOf(r_comment_start, searchStartPos)
//             if (commentStart < 0) {
//                 break;
//             }
...
//     let selectedLanguage = document.getElementById('language-box').value


//     let LHCAI = the.LanguageHelpCodeAndIds_LclJson;


//     let codesWithHelpDetails = JSON.parse(LHCAI).filter(function (entry) {
...
//         let sub_cat = item.code_sub_category;
...
//     for (let item, i = 0; item = items[i++];) {
//         let new_item = item.help_code_group;
...
//     //Auto popolate values in Help Code Group Field
//     lookup = {};
//     let sharedHelpContent = [];

//     for (let item, i = 0; item = items[i++];) {
//         let new_item = item.shared_help_content_key;
...
//     let tags = JSON.parse(sessionStorage.getItem("IdentifyCodeLanguage"));
//     if (tags != null) {
//         if (tags != "") {
//             return;
//         }
...
//     let tags = JSON.parse(sessionStorage.getItem("CommentsCombination"));
//     if (tags != null) {
//         if (tags != "") {
//             return;
//         }
...
//     //let tags = the.LanguageHelpCodeAndIds_LclJson;
//     let tags = sessionStorage.getItem("LanguageHelpCodeAndIds");
...
//     let myCodeId = the.selectedCodeId;
//     let newCodeLanguage = document.getElementById("language-box").value;
...
//     let newCodeSubTech = document.getElementById("sub-tech-box").value;
//     newCodeSubTech = newCodeSubTech.replaceAll("'", "''");

//     let newDoNotUseForScan = 0;
//     if (document.getElementById("do_not_use_for_scan").checked) {
//         newDoNotUseForScan = 1;
//     }
//     let newHelpCode = document.getElementById("help_code").value;
...
//     let newHelpCodeGroup = document.getElementById("help_code_group").value;
//     //let newHelpDetails = document.getElementById("help_details").value;
//     newHelpCodeGroup = newHelpCodeGroup.replaceAll("'", "''");

//     let newHelpDetails = tinyMCE.get('help_details').getContent()
...
//     //let newAdditionalInfo  = document.getElementById("additional_info").value;
//     let newAdditionalInfo = tinyMCE.get('additional_info').getContent()

//     newAdditionalInfo = newAdditionalInfo.replaceAll("'", "''");

//     let newSharedHelpContentKey = document.getElementById("shared_help_content_key").value;
//     newSharedHelpContentKey = newSharedHelpContentKey.replaceAll("'", "''");

//     let newCopyRightCheck = 0;
//     if (document.getElementById("copyright_check").checked) {
//         newCopyRightCheck = 1;
//     }
//     let newSearchTags = document.getElementById("help_search_tags").value;
...
//                             let filteredRows = JSON.parse(response).filter(function (entry) {
...
//     let tags = JSON.parse(sessionStorage.getItem("CodeCommentsConditions"));
//     if (tags != null) {
//         if (tags != "") {
//             return;
//         }
...
//     let tags = JSON.parse(sessionStorage.getItem("LaguagesSubCatgHelpCodeGroups"));
//     if (tags != null) {
//         if (tags != "") {
//             return;
//         }
...
//     let tags = JSON.parse(sessionStorage.getItem("HelpCodeGroupDisplayOrder"));
//     if (tags != null) {
//         if (tags != "") {
//             return;
//         }
...
//     let tags = JSON.parse(sessionStorage.getItem("LanguageForFileExtension"));
//     if (tags != null) {
//         if (tags != "") {
//             return;
//         }
...
//     let tags = JSON.parse(sessionStorage.getItem("SpecialFiles"));
//     if (tags != null) {
//         if (tags != "") {
//             return;
//         }
...
//     let tags = JSON.parse(sessionStorage.getItem("SavedProjectsList"));
//     if (tags != null) {
//         if (tags != "") {
//             return;
//         }
...
//     let newLanguage = document.getElementById("helpTopics-lang-box").value
//     if (newLanguage == "") {
...
//     let codeLanguage = sessionStorage.getItem("helpTopicsLanguage")
...
//     let codesWithHelpDetails = JSON.parse(LHCAI).filter(function (entry) {
//         let evalStr = entry.code_language;
//         if (evalStr == null) {
//             return false
//         } else {
...
//     for (let l = 0; l < codesWithHelpDetails.length; l++) {

//         let hlpCode = codesWithHelpDetails[l].help_code;
//         let hlpCdId = codesWithHelpDetails[l].code_id;
//         let hlpCdGrp = codesWithHelpDetails[l].help_code_group;
...
//     let imageName = document.getElementById("search-img").value;
//     if (imageName == "") {
//         //imageName = "coffee";
//         return;
//     }
...
//     }
//     const imageDiv = document.querySelector('.srchimages');
//     let key = "33936925-b94dd0e302df74f271d1b84c5";
...
function updateDescription(itemid, createNewItem) {
    ...
    let ele = document.getElementsByClassName('dynamicradio');
    ...
    let elem = document.getElementsByClassName('qz1-rtans');
    let kys = {};
    let ki = "";
    let val = "";
...
//     //let subFolder = document.getElementById("project-sub-folder-box").value;

//     for (let i = 0, f; f = files[i]; i++) {
//         let str = f.webkitRelativePath;
//         let pos = str.lastIndexOf("/")
//         let subFolder = str.substr(0, pos);
...
//     for (let l = 0; l < the.newProjectContent.length; l++) {

//         let hlpCode = the.newProjectContent[l][1];
//         let hlpCdId = the.newProjectContent[l][1];
//         let hlpCdGrp = the.newProjectContent[l][0];
...
//     let innerHTML = '<div style="overflow: hidden;">';
...
// function loadFile() {
//     try {
//         let fileName = localStorage.getItem("newWindowFileName");
//         //let f = JSON.parse(localStorage.getItem("newWindowFileObj"));
//         let fileData = localStorage.getItem("newWindowFileObj");
//         //console.log(f);
//         //Display three
//         document.getElementById("HelpTopicsDivId").style.display = "none";
//         document.getElementById("helpDisplayDivId").style.display = "block";
...
//             let msg = "Code Language is " + newLanguage + " based on file extension" +
...
//     let myLanguage = document.getElementById("project-language-box").value;
//     let mycategory = document.getElementById("project-sub-tech-box").value;
//     let myProjectName = document.getElementById("project-name-box").value;
//     let myProjectPath = document.getElementById("project-path-box").value;
//     myProjectDetails = tinyMCE.get('project_details').getContent();

//     let parts = myProjectDetails.split('\\');
//     let myProjectDetails = parts.join('\\\\');
...
//     let myProjectFiles = JSON.stringify(the.newProjectContent);
...
//     let innerHTML = '<div class="headerDivCls">Saved projects </div>';

//     let tf = JSON.parse(sessionStorage.getItem("SavedProjectsList"));

//     if (tf == null) {
//         return;
//     }
//     let rows = JSON.parse(tf);
//     let tempInnerHTML = document.getElementById("savedProjectList").innerHTML;
...
//     for (let i = 0; i < rows.length; i++) {
//         let myLanguage = rows[i].language;
//         let mycategory = rows[i].category;
//         let myProjectName = rows[i].project_name;
//         let myProjectDetails = rows[i].project_details;
//         let myProjectPath = rows[i].project_path;
//         let myProjectFiles = JSON.parse(rows[i].project_files);
//         let myProjectId = rows[i].project_id;
...
//             let fileName = myProjectFiles[k][1];
//             let a = fileName.split(".");
//             let fileExtension = a[1];
...
//         let innerHTML = innerHTML + '<div class="content">' +
...
//         for (let l = 0; l < myProjectFiles.length; l++) {

//             let hlpCode = myProjectFiles[l][1];
//             let hlpCdId = myProjectFiles[l][1];
//             let hlpCdGrp = myProjectFiles[l][0];
...
function categoryClicked(categoryNameOrig) {
    ...
    //let itemstr = categoryNameOrig + "/" + rows[0].title;
...
function updateParentBGColor(element) {
    ...
    //let parentSecDiv = element.parentElement.parentElement.parentElement;
