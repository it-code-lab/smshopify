...
//     let files = evt.files; // FileList object    the.uploadedFiles = files;
// }
...
//                 admgetFullShopDetails(rows, storename);
//                 document.getElementById("itemListDivId").style.display = "block";
//                 return;
//             }
//             //continue;
...
//         let tempHTML = "<div><a class='loginLinkCls' href='javascript:admgoToLogin()'>LOG IN</a> to add this to your favourites"
...
//         let tempHTML = "<div><a class='loginLinkCls' href='javascript:admgoToLogin()'>LOG IN</a> to contact the listing owner "
//         + "<div class='float_right marginleft_5px hover_pointer' onclick='closePopup()'><i class='fa fa-window-close'></i> </div>"
//         + "</div>";
...
//     if (localStorage.getItem("userLoggedIn") == "n") {
//         let tempHTML = "<div><a class='loginLinkCls' href='javascript:admgoToLogin()'>LOG IN</a> to submit review for this item "
//         + "<div class='float_right marginleft_5px hover_pointer' onclick='closePopup()'><i class='fa fa-window-close'></i> </div>"
//         + "</div>";
...
//     if (localStorage.getItem("userLoggedIn") == "n") {
//         let tempHTML = "<div><a class='loginLinkCls' href='javascript:admgoToLogin()'>LOG IN</a> to report issue with this item "
//             + "<div class='float_right marginleft_5px hover_pointer' onclick='closePopup()'><i class='fa fa-window-close'></i> </div>"
//             + "</div>";
